"""
Generate a large batch of Lagrangian trajectories or 2d/3d rotating turbulence fields
from a model and save them as a large numpy array. This can be used to produce samples
